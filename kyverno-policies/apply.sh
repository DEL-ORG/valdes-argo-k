...
kubectl apply -f "$ROOT_DIR/policies/11-deny-latest-image-tag.yaml"
kubectl apply -f "$ROOT_DIR/policies/12-require-versioned-image-tags.yaml"
kubectl apply -f "$ROOT_DIR/policies/13-generate-namespace-resourcequota.yaml"
kubectl apply -f "$ROOT_DIR/policies/14-disallow-stringdata-secrets.yaml"
kubectl apply -f "$ROOT_DIR/policies/15-deny-plaintext-envvars.yaml"
kubectl apply -f "$ROOT_DIR/policies/16-ingress-require-tls-and-approved-secret.yaml"
